...
namespace Debug_Master_Windows_CS_TAP.ObjectRepository
{
    public static class Descriptors
    {
        ...
        {
            public static Debug_Master_Windows_CS_TAP._Implementation._Calculator.__Main_screen Main_screen { get; private set; } = new Debug_Master_Windows_CS_TAP._Implementation._Calculator.__Main_screen();
        }
    }
}
    ...
    namespace _Calculator
    {
        public class __Main_screen : IScreenDescriptor
        {
            ...
            public __Main_screen()
            {
                ...
                Digit___5 = new Debug_Master_Windows_CS_TAP._Implementation._Calculator._Main_screen.__Digit___5(this, null);
                Operator___Equals = new Debug_Master_Windows_CS_TAP._Implementation._Calculator._Main_screen.__Operator___Equals(this, null);
                Operator___Multiply = new Debug_Master_Windows_CS_TAP._Implementation._Calculator._Main_screen.__Operator___Multiply(this, null);
                Result = new Debug_Master_Windows_CS_TAP._Implementation._Calculator._Main_screen.__Result(this, null);
            }

            public Debug_Master_Windows_CS_TAP._Implementation._Calculator._Main_screen.__Digit___5 Digit___5 { get; private set; }

            public Debug_Master_Windows_CS_TAP._Implementation._Calculator._Main_screen.__Operator___Equals Operator___Equals { get; private set; }

            public Debug_Master_Windows_CS_TAP._Implementation._Calculator._Main_screen.__Operator___Multiply Operator___Multiply { get; private set; }

            public Debug_Master_Windows_CS_TAP._Implementation._Calculator._Main_screen.__Result Result { get; private set; }
        }
    }
}