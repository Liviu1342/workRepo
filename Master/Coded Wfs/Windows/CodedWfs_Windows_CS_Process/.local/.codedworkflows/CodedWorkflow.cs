...
namespace CodedWfs_Windows_CS_Process
{
    ...
    {
        private Lazy<CodedWfs_Windows_CS_Process.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<CodedWfs_Windows_CS_Process.WorkflowRunnerService>(() => new CodedWfs_Windows_CS_Process.WorkflowRunnerService(this.RunWorkflow));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected CodedWfs_Windows_CS_Process.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
