...
{
    public class _23_10_8CWFActivity : System.Activities.Activity
    {
        public _23_10_8CWFActivity()
        {
            this.Implementation = () =>
            {
                return new _23_10_8CWFActivityChild()
                {};
            };
        }
    }

    internal class _23_10_8CWFActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public _23_10_8CWFActivityChild()
        {
            DisplayName = "_23_10_8CWF";
        }
        ...
        {
            var codedWorkflow = new global::L_VB_Windows_testSuite2310._5._23_10_8CWF();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "23.10.8CWF.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "23.10.8CWF.cs", Exception = exception});
                }
