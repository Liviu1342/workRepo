...
{
    public class Workflow1 : CodedWorkflow
    {
        [Workflow]
        public void Execute()
        {
            ...
            Log("something");
            var screen = uiAutomation.Open(Descriptors.FFAmazonApp.FFAmazonScreen);
            screen.Click(Descriptors.FFAmazonApp.FFAmazonScreen.Amazon_Basics);
