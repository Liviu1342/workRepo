...
namespace Connections_Win_VB_Library
{
    ...
    {
        private Lazy<Connections_Win_VB_Library.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<Connections_Win_VB_Library.WorkflowRunnerService>(() => new Connections_Win_VB_Library.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected Connections_Win_VB_Library.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
