...
{
    public class NEP2_CodedTestCaseActivity : System.Activities.Activity
    {
        public NEP2_CodedTestCaseActivity()
        {
            this.Implementation = () =>
            {
                return new NEP2_CodedTestCaseActivityChild()
                {};
            };
        }
    }

    internal class NEP2_CodedTestCaseActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public NEP2_CodedTestCaseActivityChild()
        {
            DisplayName = "NEP2_CodedTestCase";
        }
        ...
        {
            var codedWorkflow = new global::ArgumentProperties_Process_Cross_CS.NEP2_CodedTestCase();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "NEP2_CodedTestCase.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "NEP2_CodedTestCase.cs", Exception = exception});
                }
