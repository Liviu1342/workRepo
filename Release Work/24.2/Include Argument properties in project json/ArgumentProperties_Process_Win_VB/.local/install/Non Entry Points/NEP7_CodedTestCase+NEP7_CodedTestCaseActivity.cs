...
namespace ArgumentProperties_Process_Win_VB.NonEntryPoints
{
    public class NEP7_CodedTestCaseActivity : System.Activities.Activity
    {
        public NEP7_CodedTestCaseActivity()
        {
            this.Implementation = () =>
            {
                return new NEP7_CodedTestCaseActivityChild()
                {};
            };
        }
    }

    internal class NEP7_CodedTestCaseActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public NEP7_CodedTestCaseActivityChild()
        {
            DisplayName = "NEP7_CodedTestCase";
        }
        ...
        {
            var codedWorkflow = new global::ArgumentProperties_Process_Win_VB.NonEntryPoints.NEP7_CodedTestCase();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Non Entry Points\\NEP7_CodedTestCase.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Non Entry Points\\NEP7_CodedTestCase.cs", Exception = exception});
                }
