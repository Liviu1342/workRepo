...
namespace Process_Cross_VB_Complex
{
    ...
    public class EP_RootFolder_Coded_WorkflowActivity : System.Activities.Activity
    {
        public EP_RootFolder_Coded_WorkflowActivity()
        {
            this.Implementation = () =>
            {
                return new EP_RootFolder_Coded_WorkflowActivityChild()
                {};
            };
        }
    }

    internal class EP_RootFolder_Coded_WorkflowActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public EP_RootFolder_Coded_WorkflowActivityChild()
        {
            DisplayName = "EP_RootFolder_Coded_Workflow";
        }
        ...
        {
            var codedWorkflow = new global::Process_Cross_VB_Complex.EP_RootFolder_Coded_Workflow();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "EP_RootFolder_Coded_Workflow.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "EP_RootFolder_Coded_Workflow.cs", Exception = exception});
                }
