...
namespace Library_Win_VB_Entities
{
    ...
    {
        private Lazy<Library_Win_VB_Entities.WorkflowRunnerService> _workflowRunnerServiceLazy;
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<Library_Win_VB_Entities.WorkflowRunnerService>(() => new Library_Win_VB_Entities.WorkflowRunnerService(this.RunWorkflow));
        }

        protected Library_Win_VB_Entities.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
