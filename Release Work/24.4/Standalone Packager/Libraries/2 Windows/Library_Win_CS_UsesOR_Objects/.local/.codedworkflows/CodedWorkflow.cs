...
namespace Library_Win_CS_UsesOR_Objects
{
    ...
    {
        private Lazy<Library_Win_CS_UsesOR_Objects.WorkflowRunnerService> _workflowRunnerServiceLazy;
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<Library_Win_CS_UsesOR_Objects.WorkflowRunnerService>(() => new Library_Win_CS_UsesOR_Objects.WorkflowRunnerService(this.RunWorkflow));
        }

        protected Library_Win_CS_UsesOR_Objects.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
