...
namespace Library_Win_VB_PrivateActivities
{
    ...
    {
        private Lazy<Library_Win_VB_PrivateActivities.WorkflowRunnerService> _workflowRunnerServiceLazy;
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<Library_Win_VB_PrivateActivities.WorkflowRunnerService>(() => new Library_Win_VB_PrivateActivities.WorkflowRunnerService(this.RunWorkflow));
        }

        protected Library_Win_VB_PrivateActivities.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
