...
namespace Library_Win_VB_Simple.Coded
{
    ...
    internal class Workflow1ActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        ...
        {
            var codedWorkflow = new global::Library_Win_VB_Simple.Coded.Workflow1();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Coded\\FootballTeam_Custom_Activity_Coded.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Coded\\FootballTeam_Custom_Activity_Coded.cs", Exception = exception});
                }
