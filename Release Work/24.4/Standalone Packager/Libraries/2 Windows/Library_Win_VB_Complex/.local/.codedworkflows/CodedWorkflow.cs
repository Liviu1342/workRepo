...
namespace Library_Win_VB_Complex
{
    ...
    {
        private Lazy<Library_Win_VB_Complex.WorkflowRunnerService> _workflowRunnerServiceLazy;
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<Library_Win_VB_Complex.WorkflowRunnerService>(() => new Library_Win_VB_Complex.WorkflowRunnerService(this.RunWorkflow));
        }

        protected Library_Win_VB_Complex.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
