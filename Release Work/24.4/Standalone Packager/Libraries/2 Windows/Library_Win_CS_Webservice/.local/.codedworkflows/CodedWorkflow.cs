...
namespace Library_Win_CS_Webservice
{
    ...
    {
        private Lazy<Library_Win_CS_Webservice.WorkflowRunnerService> _workflowRunnerServiceLazy;
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<Library_Win_CS_Webservice.WorkflowRunnerService>(() => new Library_Win_CS_Webservice.WorkflowRunnerService(this.RunWorkflow));
        }

        protected Library_Win_CS_Webservice.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
