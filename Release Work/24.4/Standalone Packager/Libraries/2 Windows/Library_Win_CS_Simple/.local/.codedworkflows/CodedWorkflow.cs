...
namespace Library_Win_CS_Simple
{
    ...
    {
        private Lazy<Library_Win_CS_Simple.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<Library_Win_CS_Simple.WorkflowRunnerService>(() => new Library_Win_CS_Simple.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected Library_Win_CS_Simple.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
