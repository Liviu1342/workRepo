...
namespace Library_Cross_VB_Connections
{
    ...
    {
        private Lazy<Library_Cross_VB_Connections.WorkflowRunnerService> _workflowRunnerServiceLazy;
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<Library_Cross_VB_Connections.WorkflowRunnerService>(() => new Library_Cross_VB_Connections.WorkflowRunnerService(this.RunWorkflow));
        }

        protected Library_Cross_VB_Connections.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
