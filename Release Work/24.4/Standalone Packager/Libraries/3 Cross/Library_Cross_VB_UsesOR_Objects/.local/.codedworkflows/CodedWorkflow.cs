...
namespace Library_Cross_VB_UsesOR_Objects
{
    public partial class CodedWorkflow : CodedWorkflowBase
    {
        private Lazy<Library_Cross_VB_UsesOR_Objects.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<Library_Cross_VB_UsesOR_Objects.WorkflowRunnerService>(() => new Library_Cross_VB_UsesOR_Objects.WorkflowRunnerService(this.RunWorkflow));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected Library_Cross_VB_UsesOR_Objects.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
