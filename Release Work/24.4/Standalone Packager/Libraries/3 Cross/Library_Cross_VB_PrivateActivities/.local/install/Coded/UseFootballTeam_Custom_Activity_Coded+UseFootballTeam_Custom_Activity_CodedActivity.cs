...
namespace Library_Cross_VB_PrivateActivities.Coded
{
    ...
    internal class UseFootballTeam_Custom_Activity_CodedActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        ...
        {
            var codedWorkflow = new global::Library_Cross_VB_PrivateActivities.Coded.UseFootballTeam_Custom_Activity_Coded();
