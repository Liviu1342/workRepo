...
namespace Library_Cross_CS_UsesOR_Objects.Coded
{
    ...
    internal class UseFootballTeam_Custom_Activity_CodedActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        ...
        {
            var codedWorkflow = new global::Library_Cross_CS_UsesOR_Objects.Coded.UseFootballTeam_Custom_Activity_Coded();
